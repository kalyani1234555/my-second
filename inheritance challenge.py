...
# VampyreKing object will also start off with 140 hit points
# So extend Vampyre to create a VampyreKing class with those additional properties
# Test the new class by creating a new VampyreKing object and checking that it does start with 140 hit points and only
# takes a quarter og the damage inflicted
